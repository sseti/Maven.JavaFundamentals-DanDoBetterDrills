...
public class MathUtilities {
    ...
    public Float subtract(float baseValue, float difference) {
        float subtract = (float) (baseValue - difference);
        return subtract;
    }
    ...
    public Double subtract(double baseValue, double difference) {
        double subtract = (double) (baseValue - difference);
        return subtract;
    }
    ...
    public Float divide(float dividend, float divisor) {
        float divide = (float) (dividend / divisor);
        return divide;
    }
    ...
    public Double divide(double dividend, double divisor) {
        double divide = (float) (dividend / divisor);
        return divide;
    }
    ...
    public Float multiply(float multiplicand, float multiplier) {
        float multiply = (float) (multiplicand * multiplier);
        return multiply;
    }
    ...
    public Double multiply(double multiplicand, double multiplier) {
        double multiply = (double) (multiplicand * multiplier);
        return multiply;
    }
}
